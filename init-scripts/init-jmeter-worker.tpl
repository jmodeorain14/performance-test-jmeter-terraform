...
sudo aws s3 cp s3://${aws_s3_bucket_id}/rmi_keystore.jks /home/ubuntu/apache-jmeter-5.6.3/bin/

# Loop to check if the file has been successfully downloaded and is present before proceeding
echo "Copy the SSL certificate file from the S3 bucket to the EC2 instance"
while ! sudo aws s3 cp s3://${aws_s3_bucket_id}/rmi_keystore.jks /home/ubuntu/apache-jmeter-5.6.3/bin/; do
